...
for i in line1.split(","):
    if i[0]=="R":
        for _ in range(int(i[1:])):
            node.append((node[-1][0]+1,node[-1][1]))
    if i[0]=="L":
        for _ in range(int(i[1:])):
            node.append((node[-1][0]-1,node[-1][1]))
    if i[0]=="U":
        for _ in range(int(i[1:])):
            node.append((node[-1][0],node[-1][1]+1))
    if i[0]=="U":
        for _ in range(int(i[1:])):
            node.append((node[-1][0],node[-1][1]-1))
